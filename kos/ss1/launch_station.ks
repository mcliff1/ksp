...
function launch_to_parking_orbit {
    set frac to 0.
    set pitch to 90.
    local circularizationLeadTime is circularization_lead_time().
    ...
    print "Engine refire planned at eta:apoapsis < " + round(circularizationLeadTime, 0) + " seconds.".

    wait until eta:apoapsis < circularizationLeadTime.
